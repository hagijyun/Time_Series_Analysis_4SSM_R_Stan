...
x_lab[!(x_lab %in% c("Sat", "Sun"))] <- ""
par(xpd = TRUE)
text(labels =      x_lab, x = as.Date(food_day$Date), y = 1850, adj = c(0, 0.5), srt = -45)
text(labels =  "1st day", x = as.Date( "2009-06-01"), y = 1850, adj = c(0, 0.5), srt = -45)
text(labels = "30th day", x = as.Date( "2009-06-30"), y = 1850, adj = c(0, 0.5), srt = -45)
par(xpd = FALSE)
```
